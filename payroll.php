    ...
    try {
        ...
        elseif (isset($_POST['update_payroll'])) {
            ...
            $stmt_update->bind_param(
                ...
                $holidays_earnings, $basic_earned_per_month, $hra_earned_per_month,
                $actual_earnings, $total_earnings, $esi_deductions, $epf_deductions, $total_deductions,
            ...
            if ($stmt_update->execute()) {
                ...
                $_POST['generate_payslip'] = true; // Simulate a view request
            } else {
